...
<BorderLinearProgress variant="determinate" color="inherit" value={50} order={3} />
              ...
              >
                ...
                >
                  <Typography sx={{ fontWeight: 600, lineHeight: 1 }}>Bite Price</Typography>
          ...
          <Grid item xs={12} md={7}>
            ...
            Set the way of choosing food delivery services according to your preferences and save money using our Bite Price app.
            </Typography>
